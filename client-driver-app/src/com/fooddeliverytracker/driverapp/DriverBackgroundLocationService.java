...
public class DriverBackgroundLocationService extends Service implements
		GooglePlayServicesClient.ConnectionCallbacks,
		GooglePlayServicesClient.OnConnectionFailedListener, LocationListener {

	private static final String TAG = "DriverBackgroundLocationService";
	...
	public class LocalBinder extends Binder {
		public DriverBackgroundLocationService getServerInstance() {
			return DriverBackgroundLocationService.this;
		}
	}
	...
	private void handleLocation(Location location) {
		...
		// then you use
		String driverName = prefs.getString("driver_name", null);

		DriverTrackerService.getInstance(driverName).updateDriverLocation(
				driverName, location);
